...
We can use MCMC to help us out. Choose a distribution of voters, then when you click the button, the random walk algorithm will run for 1,000 steps, keeping track of the most <span style="color:#857ab8"><b>Purple</b></span>-favoring plan it's seen so far.  Every 200 steps, it restarts its walk from that best-so-far plan, and at the end it draws the best one it found.
...
You'll notice that this does pretty well, but not always perfectly.  For example, if you make the top three rows all <span style="color:#fca336"><b>Orange</b></span> and the bottom four all <span style="color:#857ab8"><b>Purple</b></span>, the algorithm will probably find a plan that lets the <span style="color:#857ab8"><b>Purple</b></span> Party win six seats, but not not seven.  This is for two reasons -- first, that there is only one plan which has seven <span style="color:#857ab8"><b>Purple</b></span>-favoring districts, and the second is that this plan has very low degree in the metagraph, so it's hard for the random walk to find it.  It's even kind of remarkable that it can even find a plan with six <span style="color:#857ab8"><b>Purple</b></span>-favoring districts.  If you plug that distribution into the sampling tool above and look at the histograms, you'll see that the vast majority of plans that sampler finds have four <span style="color:#857ab8"><b>Purple</b></span> seats, with a small handful of plans with five.  Very rarely will it even find a six-<span style="color:#857ab8"><b>Purple</b></span>-seat plan.  The modification where we restart the random walk from the best plan it's found so far turns out to be very effective for gerrymandering in favor of the <span style="color:#857ab8"><b>Purple</b></span> Party (of course it's a quick edit to make it favor the <span style="color:#fca336"><b>Orange</b></span> Party).
